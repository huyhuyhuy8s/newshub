...
router.get('/:id', async function (req, res) {
    try {
        ...
        const recentNews = await categoryService.getRecentNewsByCategory(categoryId, limit, offset);

        // lấy số lượng nút nbaams của pagnination
        const nRows = await categoryService.countNewsbyCategory(categoryId)
