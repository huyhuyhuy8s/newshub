...
('USR0012', 'Nguyễn Văn A', '1993-03-03', 'nguyenvana@example.com', 'password123'),
('USR0013', 'Trần Thị B', '1994-04-04', 'tranthib@example.com', 'password123'),
('USR0014', 'Lê Văn C', '1991-01-01', 'levanc@example.com', 'password123'),
('USR0015', 'Phạm Thị D', '1990-02-02', 'phamthid@example.com', 'password123'),
('USR0016', 'Đỗ Văn E', '1989-05-05', 'dovanE@example.com', 'password123'),
('USR0017', 'Nguyễn Thị F', '1995-06-06', 'nguyenthif@example.com', 'password123'),
('USR0018', 'Trần Văn G', '1992-07-07', 'tranvang@example.com', 'password123'),
('USR0019', 'Lê Thị H', '1993-08-08', 'lethih@example.com', 'password123'),
('USR0020', 'Phạm Văn I', '1994-09-09', 'phamvani@example.com', 'password123'),

-- Subcriber
('USR0021', 'Đỗ Thị J', '1991-10-10', 'dothij@example.com', 'password123');
...
('WRT0005', 'USR0010', 'CAT0002'),
('WRT0006', 'USR0011', 'CAT0003'),
('WRT0007', 'USR0012', 'CAT0004'),
('WRT0008', 'USR0013', 'CAT0005'),
('WRT0009', 'USR0014', 'CAT0006'),
('WRT0010', 'USR0015', 'CAT0007'),
('WRT0011', 'USR0016', 'CAT0008'),
('WRT0012', 'USR0017', 'CAT0009'),
('WRT0013', 'USR0018', 'CAT0010'),
('WRT0014', 'USR0019', 'CAT0011'),
('WRT0015', 'USR0020', 'CAT0012'); 
...
('SUB0001', 'WRT0003', 'STS0001', 'NEWS0003', '2024-12-13 10:30:00', 'Great sarticle!', 0, 450, 'AI a fascinating.', NULL, 'Title: post 3 sub 1', 'Meta_Title: post 3 sub 1', 'AI is reshaping the world4 AI is reshaping the world4 AI is reshaping the world4 AI is reshaping the world4 AI'),
...
('SUB0004', 'WRT0002', 'STS0001', 'NEWS0038', '2024-12-10 00:30:00', 'Great article!', 0, 498, 'AI  fascinating.', NULL, 'Title: post 2 sub 4', 'Meta_Title: post 2 sub 4', 'Phương Mỹ Chi và Phương Duyên song ca bài Đẩy xe bò của Phưo và câu hát mang âm hưởng quan họ trong bài.'),
...
('SUB0005', 'WRT0005', 'STS0001', 'NEWS0050', '2024-12-10 00:30:00', 'Great article!', 1, 9900008, 'AI  fascinating.', NULL, 'Title: post 2 sub 5', 'Meta_Title: post 2 sub 5', 'Đi khám phá rừng Phú Quốc là tour du lịch trải nghiệm độc đáo. Trước khi đi tham quan khách sẽ được hướng dẫn. '),
...
('SUB0006', 'WRT0005', 'STS0001', 'NEWS0067', '2024-12-12 00:30:00', 'Family bonding activities.', 0, 250, 'Bonding with family is important.', NULL, 'Title: post 3 sub 6!!!', 'Meta_Title: post 3 sub 6', 'Family bonding activities.'),
...
('SUB0007', 'WRT0005', 'STS0001', 'NEWS0069', '2024-11-15 00:30:00', 'International relations.', 0, 350, 'Relations between countries.', NULL, 'Title: post 2 sub 7', 'Meta_Title: post 2 sub 7', 'International relations overview.'),
...
-- sub11 
('SUB0011', 'WRT0006', 'STS0001', 'NEWS0084', '2024-11-02 00:30:00', 'Nutrition tips for a healthy life.', 0, 1100, 'Nutrition is key to health.', NULL, 'Title: post 1 sub 11', 'Meta_Title: post 1 sub 11', 'Nutrition tips overview.'),
...
('SUB0042', 'WRT0014', 'STS0001', 'NEWS0209',  '2024-12-14 00:30:11', 'Online learning platforms.', 0, 7350, 'Best platforms for online education.', NULL, 'Title: post 2 sub 42', 'Meta_Title: post 2 sub 42', 'Online learning platforms overview.'),
...
('SUB0044', 'WRT0014', 'STS0001', 'NEWS0217',  '2024-12-09 00:30:03', 'Top athletes to watch.', 0, 7750, 'Highlighting the best athletes.', NULL, 'Title: post 2 sub 44', 'Meta_Title: post 2 sub 44', 'Top athletes to watch overview.'),
...
('SUB0046', 'WRT0015', 'STS0001', 'NEWS0224',  '2024-12-12 00:30:00', 'Popular food trends in 2024.', 0, 8100, 'What’s trending in the culinary world.', NULL, 'Title: post 1 sub 46', 'Meta_Title: post 1 sub 46', 'Food trends overview.'),
...
('SUB0047', 'WRT0015', 'STS0001', 'NEWS0230',  '2024-11-12 00:35:00', 'Accessorizing your outfits.', 0, 8400, 'Tips for choosing the right accessories.', NULL, 'Title: post 3 sub 47', 'Meta_Title: post 3 sub 47', 'Accessorizing tips overview.'),
